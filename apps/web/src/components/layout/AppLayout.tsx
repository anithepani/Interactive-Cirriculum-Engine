    ...
    <div className="flex min-h-screen bg-canvas">
      ...
      <div className={`flex-1 transition-all duration-300 ${isSidebarCollapsed ? "lg:ml-20" : "lg:ml-64"}`}>
        ...
        <header className="sticky top-0 z-30 flex h-20 items-center justify-between border-b border-ink/5 bg-canvas/80 px-8 backdrop-blur-md">
          ...
          <div className="flex h-11 w-full max-w-md items-center gap-3 rounded-full border border-ink/10 bg-white px-4 shadow-sm focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500">
          ...
          <div className="flex items-center gap-6">
            <div className="flex gap-3">
              <button className="flex h-10 w-10 items-center justify-center rounded-full border border-ink/10 bg-white text-ink-soft transition hover:text-ink">
                <Mail className="h-4 w-4" />
              </button>
              <button className="flex h-10 w-10 items-center justify-center rounded-full border border-ink/10 bg-white text-ink-soft transition hover:text-ink relative">
